...
/**
 * PoolListExtendedInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PoolListExtendedInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pool_list_extended_inner';
     ...
     * Sets active_stake
     *
     * @param string $active_stake Active delegated amount
     *
     * @return self
     */
     ...
     * Sets live_stake
     *
     * @param string $live_stake Currently delegated amount
     *
     * @return self
     */
