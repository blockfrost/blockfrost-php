...
/**
 * TxContentStakeAddrInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TxContentStakeAddrInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tx_content_stake_addr_inner';
     ...
     * Sets address
     *
     * @param string $address Delegation stake address
     *
     * @return self
     */
     ...
     * Sets registration
     *
     * @param bool $registration Registration boolean, false if deregistration
     *
     * @return self
     */
