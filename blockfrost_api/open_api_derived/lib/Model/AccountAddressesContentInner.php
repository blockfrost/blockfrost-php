...
/**
 * AccountAddressesContentInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountAddressesContentInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'account_addresses_content_inner';
     ...
     * Sets address
     *
     * @param string $address Address associated with the stake key
     *
     * @return self
     */
