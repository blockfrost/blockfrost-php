...
/**
 * AssetHistoryInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AssetHistoryInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'asset_history_inner';
    ...
    public const ACTION_MINTED = 'minted';
    public const ACTION_BURNED = 'burned';
     ...
     * Sets tx_hash
     *
     * @param string $tx_hash Hash of the transaction containing the asset action
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string $action Action executed upon the asset policy
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string $amount Asset amount of the specific action
     *
     * @return self
     */
