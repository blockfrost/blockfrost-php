...
/**
 * BlockContentAddressesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BlockContentAddressesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'block_content_addresses_inner';
    ...
    protected static $openAPITypes = [
        'address' => 'string',
        'transactions' => '\OpenAPI\Client\Model\BlockContentAddressesInnerTransactionsInner[]'
    ];
     ...
     * Sets address
     *
     * @param string $address Address that was affected in the specified block
     *
     * @return self
     */
     ...
     * Gets transactions
     *
     * @return \OpenAPI\Client\Model\BlockContentAddressesInnerTransactionsInner[]
     */
     ...
     * Sets transactions
     *
     * @param \OpenAPI\Client\Model\BlockContentAddressesInnerTransactionsInner[] $transactions List of transactions containing the address either in their inputs or outputs. Sorted by transaction index within a block, ascending.
     *
     * @return self
     */
