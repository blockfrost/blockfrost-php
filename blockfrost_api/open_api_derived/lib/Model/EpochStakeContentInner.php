...
/**
 * EpochStakeContentInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EpochStakeContentInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'epoch_stake_content_inner';
     ...
     * Sets stake_address
     *
     * @param string $stake_address Stake address
     *
     * @return self
     */
     ...
     * Sets pool_id
     *
     * @param string $pool_id Bech32 prefix of the pool delegated to
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string $amount Amount of active delegated stake in Lovelaces
     *
     * @return self
     */
