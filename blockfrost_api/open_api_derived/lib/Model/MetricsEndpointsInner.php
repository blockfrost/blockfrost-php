...
/**
 * MetricsEndpointsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MetricsEndpointsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'metrics_endpoints_inner';
     ...
     * Sets time
     *
     * @param int $time Starting time of the call count interval (ends midnight UTC) in UNIX time
     *
     * @return self
     */
     ...
     * Sets calls
     *
     * @param int $calls Sum of all calls for a particular day and endpoint
     *
     * @return self
     */
     ...
     * Sets endpoint
     *
     * @param string $endpoint Endpoint parent name
     *
     * @return self
     */
