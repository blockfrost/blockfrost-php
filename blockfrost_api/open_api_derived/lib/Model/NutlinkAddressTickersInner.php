...
/**
 * NutlinkAddressTickersInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NutlinkAddressTickersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'nutlink_address_tickers_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['latest_block'] = $data['latest_block'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['latest_block'] === null) {
            $invalidProperties[] = "'latest_block' can't be null";
        }
     ...
     * Sets count
     *
     * @param int $count Number of ticker records
     *
     * @return self
     */
    ...
    {
        return $this->container['latest_block'];
    }

    /**
     * Sets latest_block
     *
     * @param int $latest_block Block height of the latest record
     *
     * @return self
     */
    public function setLatestBlock($latest_block)
    {
        $this->container['latest_block'] = $latest_block;
