...
/**
 * ScriptRedeemersInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScriptRedeemersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'script_redeemers_inner';
     ...
     * Sets tx_index
     *
     * @param int $tx_index The index of the redeemer pointer in the transaction
     *
     * @return self
     */
