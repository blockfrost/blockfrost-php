...
/**
 * AddressUtxoContentInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddressUtxoContentInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'address_utxo_content_inner';
    ...
    protected static $openAPITypes = [
        ...
        'tx_index' => 'int',
        'output_index' => 'int',
        'amount' => '\OpenAPI\Client\Model\TxContentOutputAmountInner[]',
        'block' => 'string',
        'data_hash' => 'string'
    ];
     ...
     * Sets tx_hash
     *
     * @param string $tx_hash Transaction hash of the UTXO
     *
     * @return self
     */
     ...
     * Sets tx_index
     *
     * @param int $tx_index UTXO index in the transaction
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets amount
     *
     * @param \OpenAPI\Client\Model\TxContentOutputAmountInner[] $amount amount
     *
     * @return self
     */
     ...
     * Sets block
     *
     * @param string $block Block hash of the UTXO
     *
     * @return self
     */
