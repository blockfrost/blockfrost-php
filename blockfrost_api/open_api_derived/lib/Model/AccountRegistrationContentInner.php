...
/**
 * AccountRegistrationContentInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountRegistrationContentInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'account_registration_content_inner';
    ...
    public const ACTION_DEREGISTERED = 'deregistered';
     ...
     * Sets tx_hash
     *
     * @param string $tx_hash Hash of the transaction containing the (de)registration certificate
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string $action Action in the certificate
     *
     * @return self
     */
