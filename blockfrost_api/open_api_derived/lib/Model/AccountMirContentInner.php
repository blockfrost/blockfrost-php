...
/**
 * AccountMirContentInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountMirContentInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'account_mir_content_inner';
     ...
     * Sets tx_hash
     *
     * @param string $tx_hash Hash of the transaction containing the MIR
     *
     * @return self
     */
