...
/**
 * AccountRewardContentInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountRewardContentInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'account_reward_content_inner';
    ...
    public const TYPE_POOL_DEPOSIT_REFUND = 'pool_deposit_refund';
     ...
     * Sets epoch
     *
     * @param int $epoch Epoch of the associated reward
     *
     * @return self
     */
     ...
     * Sets pool_id
     *
     * @param string $pool_id Bech32 pool ID being delegated to
     *
     * @return self
     */
