...
/**
 * AccountHistoryContentInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountHistoryContentInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'account_history_content_inner';
     ...
     * Sets active_epoch
     *
     * @param int $active_epoch Epoch in which the stake was active
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string $amount Stake amount in Lovelaces
     *
     * @return self
     */
