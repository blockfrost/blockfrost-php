...
/**
 * TxContentDelegationsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TxContentDelegationsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tx_content_delegations_inner';
     ...
     * Sets index
     *
     * @param int $index Index of the certificate within the transaction
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets address
     *
     * @param string $address Bech32 delegation stake address
     *
     * @return self
     */
     ...
     * Sets pool_id
     *
     * @param string $pool_id Bech32 ID of delegated stake pool
     *
     * @return self
     */
