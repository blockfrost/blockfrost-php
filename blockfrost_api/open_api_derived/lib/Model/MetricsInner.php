...
/**
 * MetricsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MetricsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'metrics_inner';
     ...
     * Sets calls
     *
     * @param int $calls Sum of all calls for a particular day
     *
     * @return self
     */
