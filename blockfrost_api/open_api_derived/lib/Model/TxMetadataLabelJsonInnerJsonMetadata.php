...
/**
 * TxMetadataLabelJsonInnerJsonMetadata Class Doc Comment
 *
 * @category Class
 ...
 */
class TxMetadataLabelJsonInnerJsonMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tx_metadata_label_json_inner_json_metadata';
