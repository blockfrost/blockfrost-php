...
/**
 * AccountWithdrawalContentInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountWithdrawalContentInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'account_withdrawal_content_inner';
     ...
     * Sets tx_hash
     *
     * @param string $tx_hash Hash of the transaction containing the withdrawal
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string $amount Withdrawal amount in Lovelaces
     *
     * @return self
     */
