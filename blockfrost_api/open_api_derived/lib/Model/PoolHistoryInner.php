...
/**
 * PoolHistoryInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PoolHistoryInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pool_history_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['delegators_count'] = $data['delegators_count'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['delegators_count'] === null) {
            $invalidProperties[] = "'delegators_count' can't be null";
        }
     ...
     * Sets blocks
     *
     * @param int $blocks Number of blocks created by pool
     *
     * @return self
     */
     ...
     * Sets active_stake
     *
     * @param string $active_stake Active (Snapshot of live stake 2 epochs ago) stake in Lovelaces
     *
     * @return self
     */
     ...
     * Sets active_size
     *
     * @param float $active_size Pool size (percentage) of overall active stake at that epoch
     *
     * @return self
     */
     ...
     *
     * @param int $delegators_count Number of delegators for epoch
     *
     * @return self
     */
     ...
     * Sets rewards
     *
     * @param string $rewards Total rewards received before distribution to delegators
     *
     * @return self
     */
     ...
     * Sets fees
     *
     * @param string $fees Pool operator rewards
     *
     * @return self
     */
