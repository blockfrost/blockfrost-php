...
/**
 * TxMetadataLabelsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TxMetadataLabelsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tx_metadata_labels_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['cip10'] = $data['cip10'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cip10'] === null) {
            $invalidProperties[] = "'cip10' can't be null";
        }
     ...
     * @return string
     */
    public function getCip10()
    {
        return $this->container['cip10'];
    }

    /**
     * Sets cip10
     *
     * @param string $cip10 CIP10 defined description
     *
     * @return self
     */
    public function setCip10($cip10)
    {
        $this->container['cip10'] = $cip10;
     ...
     * Sets count
     *
     * @param string $count The count of metadata entries with a specific label
     *
     * @return self
     */
