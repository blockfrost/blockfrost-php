...
/**
 * AccountDelegationContentInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountDelegationContentInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'account_delegation_content_inner';
     ...
     * Sets active_epoch
     *
     * @param int $active_epoch Epoch in which the delegation becomes active
     *
     * @return self
     */
     ...
     * Sets tx_hash
     *
     * @param string $tx_hash Hash of the transaction containing the delegation
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string $amount Rewards for given epoch in Lovelaces
     *
     * @return self
     */
     ...
     * Sets pool_id
     *
     * @param string $pool_id Bech32 ID of pool being delegated to
     *
     * @return self
     */
