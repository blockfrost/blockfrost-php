...
/**
 * TxContentMirsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TxContentMirsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tx_content_mirs_inner';
    ...
    public const POT_RESERVE = 'reserve';
    public const POT_TREASURY = 'treasury';
     ...
     * @return string[]
     */
    public function getPotAllowableValues()
    {
        return [
            self::POT_RESERVE,
            self::POT_TREASURY,
    ...
    {
        $this->container['pot'] = $data['pot'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getPotAllowableValues();
        if (!is_null($this->container['pot']) && !in_array($this->container['pot'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'pot', must be one of '%s'",
                $this->container['pot'],
     ...
     * Sets pot
     *
     * @param string $pot Source of MIR funds
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getPotAllowableValues();
        if (!in_array($pot, $allowedValues, true)) {
     ...
     * Sets address
     *
     * @param string $address Bech32 stake address
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string $amount MIR amount in Lovelaces
     *
     * @return self
     */
