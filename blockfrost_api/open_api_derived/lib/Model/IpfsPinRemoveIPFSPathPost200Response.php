...
/**
 * IpfsPinRemoveIPFSPathPost200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IpfsPinRemoveIPFSPathPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_ipfs_pin_remove__IPFS_path__post_200_response';
    ...
    public const STATE_QUEUED_PINNED_UNPINNED_FAILED_GC = 'queued|pinned|unpinned|failed|gc';
