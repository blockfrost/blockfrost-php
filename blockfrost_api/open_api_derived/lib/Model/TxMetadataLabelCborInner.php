...
/**
 * TxMetadataLabelCborInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TxMetadataLabelCborInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tx_metadata_label_cbor_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['cbor_metadata'] = $data['cbor_metadata'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cbor_metadata'] === null) {
            $invalidProperties[] = "'cbor_metadata' can't be null";
        }
     ...
     * @deprecated
     */
    public function getCborMetadata()
    {
        return $this->container['cbor_metadata'];
    }

    /**
     * Sets cbor_metadata
     *
     * @param string $cbor_metadata Content of the CBOR metadata
     *
     * @return self
     * @deprecated
     */
    public function setCborMetadata($cbor_metadata)
    {
        $this->container['cbor_metadata'] = $cbor_metadata;
     ...
     * Sets metadata
     *
     * @param string $metadata Content of the CBOR metadata in hex
     *
     * @return self
     */
