...
/**
 * PoolListRetireInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PoolListRetireInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pool_list_retire_inner';
     ...
     * Sets epoch
     *
     * @param int $epoch Retirement epoch number
     *
     * @return self
     */
