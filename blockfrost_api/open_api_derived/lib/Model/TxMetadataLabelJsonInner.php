...
/**
 * TxMetadataLabelJsonInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TxMetadataLabelJsonInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tx_metadata_label_json_inner';
    ...
    protected static $openAPITypes = [
        'tx_hash' => 'string',
        'json_metadata' => '\OpenAPI\Client\Model\TxMetadataLabelJsonInnerJsonMetadata'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['json_metadata'] = $data['json_metadata'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['json_metadata'] === null) {
            $invalidProperties[] = "'json_metadata' can't be null";
        }
     ...
     * Sets tx_hash
     *
     * @param string $tx_hash Transaction hash that contains the specific metadata
     *
     * @return self
     */
     ...
     * Gets json_metadata
     *
     * @return \OpenAPI\Client\Model\TxMetadataLabelJsonInnerJsonMetadata
     */
    public function getJsonMetadata()
    {
        return $this->container['json_metadata'];
    }

    /**
     * Sets json_metadata
     *
     * @param \OpenAPI\Client\Model\TxMetadataLabelJsonInnerJsonMetadata $json_metadata json_metadata
     *
     * @return self
     */
    public function setJsonMetadata($json_metadata)
    {
        $this->container['json_metadata'] = $json_metadata;
