...
/**
 * PoolUpdatesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PoolUpdatesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pool_updates_inner';
     ...
     * Sets tx_hash
     *
     * @param string $tx_hash Transaction ID
     *
     * @return self
     */
     ...
     * Sets cert_index
     *
     * @param int $cert_index Certificate within the transaction
     *
     * @return self
     */
