...
/**
 * AssetAddressesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AssetAddressesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'asset_addresses_inner';
     ...
     * Sets address
     *
     * @param string $address Address containing the specific asset
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param string $quantity Asset quantity on the specific address
     *
     * @return self
     */
