...
/**
 * TxContentRedeemersInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TxContentRedeemersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tx_content_redeemers_inner';
    ...
    protected static $setters = [
        ...
        'datum_hash' => 'setDatumHash',
        'unit_mem' => 'setUnitMem',
        'unit_steps' => 'setUnitSteps',
        'fee' => 'setFee'
    ];
    ...
    protected static $getters = [
        ...
        'datum_hash' => 'getDatumHash',
        'unit_mem' => 'getUnitMem',
        'unit_steps' => 'getUnitSteps',
        'fee' => 'getFee'
    ];
    ...
    public const PURPOSE_SPEND = 'spend';
    public const PURPOSE_MINT = 'mint';
    public const PURPOSE_CERT = 'cert';
    public const PURPOSE_REWARD = 'reward';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['datum_hash'] = $data['datum_hash'] ?? null;
        $this->container['unit_mem'] = $data['unit_mem'] ?? null;
        $this->container['unit_steps'] = $data['unit_steps'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['datum_hash'] === null) {
            $invalidProperties[] = "'datum_hash' can't be null";
        }
        if ($this->container['unit_mem'] === null) {
            $invalidProperties[] = "'unit_mem' can't be null";
        }
        if ($this->container['unit_steps'] === null) {
            $invalidProperties[] = "'unit_steps' can't be null";
        }
     ...
     * Sets tx_index
     *
     * @param int $tx_index Index of the redeemer within the transaction
     *
     * @return self
     */
     ...
     * Sets purpose
     *
     * @param string $purpose Validation purpose
     *
     * @return self
     */
     ...
     * @return string
     */
    public function getDatumHash()
    {
        return $this->container['datum_hash'];
    }

    /**
     * Sets datum_hash
     *
     * @param string $datum_hash Datum hash
     *
     * @return self
     */
    public function setDatumHash($datum_hash)
    {
        $this->container['datum_hash'] = $datum_hash;
     ...
     * @return string
     */
    public function getUnitMem()
    {
        return $this->container['unit_mem'];
    }

    /**
     * Sets unit_mem
     *
     * @param string $unit_mem The budget in Memory to run a script
     *
     * @return self
     */
    public function setUnitMem($unit_mem)
    {
        $this->container['unit_mem'] = $unit_mem;
     ...
     * @return string
     */
    public function getUnitSteps()
    {
        return $this->container['unit_steps'];
    }

    /**
     * Sets unit_steps
     *
     * @param string $unit_steps The budget in CPU steps to run a script
     *
     * @return self
     */
    public function setUnitSteps($unit_steps)
    {
        $this->container['unit_steps'] = $unit_steps;
     ...
     * Sets fee
     *
     * @param string $fee The fee consumed to run the script
     *
     * @return self
     */
