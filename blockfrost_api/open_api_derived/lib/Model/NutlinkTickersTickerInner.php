...
/**
 * NutlinkTickersTickerInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NutlinkTickersTickerInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'nutlink_tickers_ticker_inner';
    ...
    protected static $openAPITypes = [
        ...
        'block_height' => 'int',
        'tx_index' => 'int',
        'payload' => '\OpenAPI\Client\Model\NutlinkAddressTickerInnerPayload'
    ];
     ...
     * Sets address
     *
     * @param string $address Address of a metadata oracle
     *
     * @return self
     */
     ...
     * Sets block_height
     *
     * @param int $block_height Block height of the record
     *
     * @return self
     */
     ...
     * Sets tx_index
     *
     * @param int $tx_index Transaction index within the block
     *
     * @return self
     */
     ...
     * Gets payload
     *
     * @return \OpenAPI\Client\Model\NutlinkAddressTickerInnerPayload
     */
     ...
     * Sets payload
     *
     * @param \OpenAPI\Client\Model\NutlinkAddressTickerInnerPayload $payload payload
     *
     * @return self
     */
