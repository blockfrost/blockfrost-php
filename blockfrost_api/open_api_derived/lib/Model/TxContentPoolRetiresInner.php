...
/**
 * TxContentPoolRetiresInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TxContentPoolRetiresInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tx_content_pool_retires_inner';
    ...
    protected static $setters = [
        ...
        'pool_id' => 'setPoolId',
        'retiring_epoch' => 'setRetiringEpoch'
    ];
    ...
    protected static $getters = [
        ...
        'pool_id' => 'getPoolId',
        'retiring_epoch' => 'getRetiringEpoch'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['retiring_epoch'] = $data['retiring_epoch'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['retiring_epoch'] === null) {
            $invalidProperties[] = "'retiring_epoch' can't be null";
        }
     ...
     * Sets pool_id
     *
     * @param string $pool_id Bech32 stake pool ID
     *
     * @return self
     */
     ...
     * @return int
     */
    public function getRetiringEpoch()
    {
        return $this->container['retiring_epoch'];
    }

    /**
     * Sets retiring_epoch
     *
     * @param int $retiring_epoch Epoch in which the pool becomes retired
     *
     * @return self
     */
    public function setRetiringEpoch($retiring_epoch)
    {
        $this->container['retiring_epoch'] = $retiring_epoch;
