...
/**
 * NutlinkAddressTickerInnerPayload Class Doc Comment
 *
 * @category Class
 ...
 */
class NutlinkAddressTickerInnerPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'nutlink_address_ticker_inner_payload';
