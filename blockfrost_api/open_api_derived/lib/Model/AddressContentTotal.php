...
class AddressContentTotal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'address' => 'string',
        'received_sum' => '\OpenAPI\Client\Model\TxContentOutputAmountInner[]',
        'sent_sum' => '\OpenAPI\Client\Model\TxContentOutputAmountInner[]',
        'tx_count' => 'int'
    ];
     ...
     * Sets received_sum
     *
     * @param \OpenAPI\Client\Model\TxContentOutputAmountInner[] $received_sum received_sum
     *
     * @return self
     */
     ...
     * Sets sent_sum
     *
     * @param \OpenAPI\Client\Model\TxContentOutputAmountInner[] $sent_sum sent_sum
     *
     * @return self
     */
